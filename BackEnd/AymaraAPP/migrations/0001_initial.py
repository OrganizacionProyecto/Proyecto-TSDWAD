# Generated by Django 4.2 on 2024-06-01 00:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_carrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pedidos', to='AymaraAPP.carrito')),
        ...
        migrations.AddField(
            model_name='carrito',
            name='productos',
            field=models.ManyToManyField(blank=True, related_name='carritos', to='AymaraAPP.agregarproducto'),
        ),
        migrations.AddField(
